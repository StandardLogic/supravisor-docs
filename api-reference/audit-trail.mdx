...
description: "Read, query, export, and share cryptographic records of all authorization decisions. Every entry is signed and tamper-proof."
---
...
The `gate_signature` covers every other field in the document. Verify it independently using the gate's public key — see [Attestations → Verifying Signatures Offline](/concepts/attestations).
