---
title: "Authorize API"
description: "Gate check, CEL constraint enforcement, and dry-run testing."
---
...
<CardGroup cols={2}>
  <Card title="Constraints (26 Evaluators)" href="/concepts/guardrails" icon="sliders">
    Full reference for all constraint types, categories, and sequences.
  </Card>
  <Card title="Attestations API" href="/api-reference/audit-trail" icon="scroll">
