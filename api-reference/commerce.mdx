---
title: "Commerce API"
description: "Consumption attestations, settlement, and SLA compliance reporting."
---
...
<CardGroup cols={2}>
  <Card title="Commerce Concepts" href="/concepts/commerce" icon="credit-card">
  ...
  <Card title="MCP Tools" href="/sdk/mcp-tools" icon="wrench">
