---
title: "Discovery API"
description: "Public, unauthenticated service discovery for AI agents. Trustless — results are cryptographically verifiable."
---
...
<CardGroup cols={2}>
  <Card title="Catalogs" href="/concepts/catalogs" icon="book">
    How to build and publish a discoverable catalog.
  </Card>
  <Card title="Commerce & Billing" href="/concepts/commerce" icon="credit-card">
  ...
  <Card title="MCP: discover_services" href="/sdk/mcp-tools" icon="wrench">
