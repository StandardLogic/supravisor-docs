---
title: "Gates API"
description: "Create, configure, and manage enforcement checkpoints. Gates verify agent passports and evaluate guardrails on every request."
---
...
<Note>
  Save the `public_key` from the response — you'll need it to independently verify attestation signatures without trusting Supravisor's API. See [Attestations → Verifying Signatures Offline](/concepts/attestations).
</Note>
...
<CardGroup cols={2}>
  <Card title="Guardrails API" href="/api-reference/guardrails" icon="sliders">
