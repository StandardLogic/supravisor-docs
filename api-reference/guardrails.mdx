...
description: "Create reusable constraint configurations and apply them across multiple gates. Define once, enforce everywhere."
---
...
<CardGroup cols={2}>
  <Card title="Guardrails Concept" href="/concepts/guardrails" icon="sliders">
