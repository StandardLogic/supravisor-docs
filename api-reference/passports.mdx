---
title: "Passports API"
description: "Issue, list, revoke, and authorize agent credentials. The Passports API is how you create and manage cryptographic agent identity."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Passports Concept" href="/concepts/passports" icon="id-card">
