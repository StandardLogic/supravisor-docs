...
description: "A public lobby for unauthenticated visitors — with a front desk that knows how to issue key cards."
---
...
<CardGroup cols={2}>
  <Card title="Gates" href="/concepts/gates" icon="shield-check">
    The full gate concept — how enforcement works with and without passports.
  </Card>
  <Card title="Catalogs" href="/concepts/catalogs" icon="list">
