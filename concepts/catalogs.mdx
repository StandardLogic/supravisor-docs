...
description: "Publish what your gate offers, what it costs, and what it guarantees — in a cryptographically signed, discoverable format."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Autonomy" href="/guides/agent-autonomy" icon="robot">
