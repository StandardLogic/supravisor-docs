...
description: "Bilateral metering, consumption attestations, and trustless settlement for agent-to-agent transactions."
---
...
<CardGroup cols={2}>
  <Card title="Commerce API" href="/api-reference/commerce" icon="code">
  ...
  <Card title="Discovery API" href="/api-reference/discovery" icon="search">
    Public service discovery for agents.
  </Card>
  <Card title="Use Case: Travel Agent" href="/use-cases/travel-agent" icon="plane">
