---
title: "Gates"
description: "The enforcement checkpoint that verifies every agent credential — sub-millisecond, local, no network call."
---
...
[Configure anonymous access →](/concepts/anonymous-access)
...
<Card title="Deep dive: Trust Profiles" href="/concepts/trust-profiles" icon="layers">
...
[See all 26 constraint types →](/concepts/guardrails)
...
That attestation is signed by the gate's private key and cannot be altered. [Learn more about Attestations →](/concepts/attestations)
...
<CardGroup cols={2}>
  ...
  <Card title="Anonymous Access" href="/concepts/anonymous-access" icon="door-open">
