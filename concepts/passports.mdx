---
title: "Passports"
description: "Give your agent a verified identity and enforced constraints — in five minutes, no gate required."
---

# Passports

A passport is your agent's identity. A driver's license and an insurance policy, fused into a single cryptographically signed document.
...
Issue a passport and your agent has policy enforcement immediately. No gate. No account. No infrastructure. Just a signed credential that any gate can verify in under a millisecond — and that enforces its own permissions even without a gate.
...
<CardGroup cols={2}>
  <Card title="Add a Gate" href="/concepts/gates" icon="shield">
