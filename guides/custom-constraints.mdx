...
description: "You decide the rules. Build exactly the guardrail configuration your agent needs."
---
...
<CardGroup cols={2}>
  <Card title="All 26 Constraints" href="/concepts/guardrails" icon="sliders">
