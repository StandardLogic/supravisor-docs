...
description: "Start with what you need. Add layers when you're ready. No forced migration."
---
...
<AccordionGroup>
  <Accordion title="I just want to add constraints to my agents">
    ...
    [→ Passport Issuer Quickstart](/quickstart)
  </Accordion>
  ...
  <Accordion title="I want to protect my API from unauthorized agents">
    ...
    [→ Gate Operator Quickstart](/quickstart-gate)
  </Accordion>
  ...
  <Accordion title="I'm building a multi-agent marketplace or SaaS platform">
    ...
    [→ Commerce Concepts](/concepts/commerce) | [→ Catalogs](/concepts/catalogs)
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Passport Issuer Quickstart" href="/quickstart" icon="robot">
    Start with Level 1 — no infrastructure needed.
  </Card>
  <Card title="Gate Operator Quickstart" href="/quickstart-gate" icon="shield">
    Start with Level 2 — deploy before your agents are ready.
  </Card>
  <Card title="Concepts: Gates" href="/concepts/gates" icon="book">
    Deep dive into gates, security profiles, and trust configuration.
  </Card>
  <Card title="Concepts: Commerce" href="/concepts/commerce" icon="credit-card">
