---
title: "Quickstart — Gate Operator"
description: "Protect your API or MCP server in 15 minutes. No agents needed to start."
---
...
<Note>
  This is the **Gate Operator** path. If you're building AI agents that need credentials, see the [Passport Issuer Quickstart →](/quickstart)
</Note>
...
<CardGroup cols={2}>
  <Card title="Anonymous Access" href="/concepts/anonymous-access" icon="eye">
    Full anonymous access configuration reference.
  </Card>
  <Card title="Upgrade to L2" href="/concepts/gates" icon="shield">
    Require trusted issuers for production security.
  </Card>
  <Card title="Publish a Catalog" href="/concepts/catalogs" icon="book">
    Define your service's capabilities with anti-bait-and-switch pricing.
  </Card>
  <Card title="26 Constraint Evaluators" href="/concepts/guardrails" icon="sliders">
