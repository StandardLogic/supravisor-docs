---
title: "MCP Tools"
description: "32 tools for managing Supravisor from Claude or any MCP-compatible client."
---
...
<CardGroup cols={2}>
  <Card title="API Keys" href="/api-reference/authentication" icon="key">
  ...
  <Card title="Commerce API" href="/api-reference/commerce" icon="credit-card">
